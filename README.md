...
| V0.4.0 | 2026-4-21 | 1. 更新引用库，升级项目框架到 .Net 10.0。 2. 添加ExportTo方法 |
| V0.4.1 | 2026-4-22 | 1. 重构BaseReader，修复部分导入报错问题 |
| V0.4.2 | 2026-5-25 | Parallel-For在.NET 10 NPOI 2.8后频繁报错，已改用普通For循环 |
